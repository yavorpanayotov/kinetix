...
- [ ] **Populate per-instrument DV01 / Theta / Rho.** Same code path as above; add DV01 to the gateway response, plumb to UI column. Write a failing acceptance test asserting `DV01 > 0` for a Treasury fixture and `DV01 == 0` for a cash-equity fixture.
