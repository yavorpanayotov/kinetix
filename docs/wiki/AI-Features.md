...
This page is the single reference for the AI integration. The authoritative architecture decision is [ADR-0036](https://github.com/yavorpanayotov/kinetix/blob/main/docs/adr/0036-ai-copilot-architecture.md); the v1 and v2 execution plans live in [`docs/plans/ai-v1.md`](https://github.com/yavorpanayotov/kinetix/blob/main/docs/plans/ai-v1.md) and [`docs/plans/ai-v2.md`](https://github.com/yavorpanayotov/kinetix/blob/main/docs/plans/ai-v2.md).
