...
A live portfolio grid with valuation and risk analytics per holding. Source: [`PositionGrid.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PositionGrid.tsx).

![Positions tab](https://raw.githubusercontent.com/yavorpanayotov/kinetix/main/docs/screenshots/positions-tab.png)
...
A footer totals the VaR-contribution column (which can exceed 100% because of diversification offsets). When a single book is selected, a **notes** column lets you attach and delete per-instrument notes via a popover ([`PositionNotePopover.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PositionNotePopover.tsx)).
...
Every trade with fill status and venue routing. Source: [`TradeBlotter.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/TradeBlotter.tsx).

![Trade blotter](https://raw.githubusercontent.com/yavorpanayotov/kinetix/main/docs/screenshots/trades-blotter.png)
...
A minimal order ticket (cash equity) that routes through the FIX gateway. Source: [`PlaceOrderPanel.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PlaceOrderPanel.tsx).
...
- **Pre-trade risk preview** — once the required fields are filled, a panel previews the candidate order's risk impact before you submit ([`PreTradeRiskPreviewPanel.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PreTradeRiskPreviewPanel.tsx)).
...
Realised slippage and transaction-cost analysis on filled orders. Source: [`ExecutionCostPanel.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/ExecutionCostPanel.tsx).
...
Internal positions vs. prime-broker holdings. Source: [`ReconciliationPanel.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/ReconciliationPanel.tsx).
...
Intraday P&L and daily attribution to Greek factors. Source: [`PnlTab.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PnlTab.tsx).

![P&L tab](https://raw.githubusercontent.com/yavorpanayotov/kinetix/main/docs/screenshots/pnl-tab.png)
...
Attribution is measured against an SOD baseline ([`SodBaselineIndicator.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/SodBaselineIndicator.tsx)):
...
- **Waterfall chart** — total P&L decomposed into its components ([`PnlWaterfallChart.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PnlWaterfallChart.tsx)).
- **Factor attribution table** — per position: Total P&L plus Delta / Gamma / Vega / Theta / Rho contributions and an **Unexplained** residual ([`PnlAttributionTable.tsx`](https://github.com/yavorpanayotov/kinetix/blob/main/ui/src/components/PnlAttributionTable.tsx)).
