...
Markdown files in this directory are the **source of truth for the GitHub Wiki** at <https://github.com/yavorpanayotov/kinetix/wiki>.
...
1. Go to <https://github.com/yavorpanayotov/kinetix/wiki> and click **Create the first page** — any content; it will be overwritten.
2. Clone the wiki repo locally:
   ```bash
   git clone git@github.com:yavorpanayotov/kinetix.wiki.git ../kinetix.wiki
   ```
...
- Links to source code use absolute URLs (`https://github.com/yavorpanayotov/kinetix/blob/main/...`) so they resolve correctly on the wiki, which lives outside the repo tree.
